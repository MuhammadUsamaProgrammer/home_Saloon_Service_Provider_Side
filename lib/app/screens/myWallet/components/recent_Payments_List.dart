...
class RecentTransactionList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double sizedBoxHeight = 13;
    int items = 3;
    return Container(
      height: (containerHeight + sizedBoxHeight) * items.toDouble(),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '22-Oct-2022',
                              style: MyTextStyle.recent_Payments_Date(context),
                            ),
                            // transection reason
                            Text(
                              'Me Time',
                              style:
                                  MyTextStyle.recent_Payments_Reason(context),
                            ),
                          ],
                        ),
                      ),
